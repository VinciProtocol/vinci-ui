...
export interface VinciNFTInterface extends utils.Interface {
  functions: {
    ...
    'mint(bytes32[],uint256)': FunctionFragment
    'owner()': FunctionFragment
    'renounceOwnership()': FunctionFragment
    'safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)': FunctionFragment
    'safeTransferFrom(address,address,uint256,uint256,bytes)': FunctionFragment
    'setApprovalForAll(address,bool)': FunctionFragment
    'setParams(string,bytes32)': FunctionFragment
  ...
  encodeFunctionData(functionFragment: 'mint', values: [BytesLike[], BigNumberish]): string
  ...
  encodeFunctionData(functionFragment: 'setParams', values: [string, BytesLike]): string
...
export interface VinciNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: VinciNFTInterface
  ...
  functions: {
    ...
    hasClaimed(addr: string, overrides?: CallOverrides): Promise<[boolean]>
  ...
  callStatic: {
    ...
    mint(_merkleProof: BytesLike[], amount: BigNumberish, overrides?: CallOverrides): Promise<void>
    ...
    setParams(newBaseURI: string, newMerkleRoot: BytesLike, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    hasClaimed(addr: string, overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    hasClaimed(addr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
