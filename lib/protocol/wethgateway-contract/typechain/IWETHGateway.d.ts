...
import type { ContractTransaction, Overrides, PayableOverrides, CallOverrides } from '@ethersproject/contracts'
...
interface IWETHGatewayInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'borrowETH', values: [string, BigNumberish, BigNumberish, BigNumberish]): string
...
export class IWETHGateway extends Contract {
  ...
  callStatic: {
    ...
    withdrawETH(lendingPool: string, amount: BigNumberish, onBehalfOf: string, overrides?: CallOverrides): Promise<void>
