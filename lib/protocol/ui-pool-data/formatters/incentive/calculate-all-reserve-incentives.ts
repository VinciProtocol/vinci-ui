import type { CalculateReserveIncentivesResponse } from './calculate-reserve-incentives'
import { calculateReserveIncentives } from './calculate-reserve-incentives'
import type { ReserveCalculationData, ReserveIncentiveWithFeedsResponse } from './types'
...
function calculateRewardTokenPrice(reserves: ReserveCalculationData[], address: string, priceFeed: string): string {
