...
export const userReserveIncentives = [aETHUserIncentiveData, aUSDCUserIncentiveData, aXSUSHIUserIncentiveData]
...
export const userReserves: UserReserveCalculationData[] = [aETHReserve, aUSDCReserve, aXSUSHIReserve]
...
export const allIncentivesReservesWithRewardReserve: ReserveCalculationData[] = [...allIncentivesReserves, aaveReserve]
